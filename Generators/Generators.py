...
class Generators:
    ...
    def absolute_cosine_generate(number):
        ...
        Logging.text_file_logger.debug("absolute_cosine_generate(): Generated abs(cos): " + str(num))
        return num
    ...
    def absolute_sine_generate(number):
        ...
        Logging.text_file_logger.debug("absolute_sine_generate(): Generated abs(sin): " + str(num))
        return num
    ...
    def exponent_sine_generate(number):
        ...
        Logging.text_file_logger.debug("exponent_sine_generate(): Generated exp(sin): " + str(num))
        return num
    ...
    def absolute_sine_cosine_generate(number):
        ...
        Logging.text_file_logger.debug("absolute_sine_cosine_generate(): Generated sin(cos): " + str(num))
        return num
    ...
    def linear_congruent_generate(prev_value, multiplier, offset, divisor):
        ...
        Logging.text_file_logger.debug("linear_congruent_generate(): Generated (a*Xn-1 + c) % m: " + str(num))
        return num
